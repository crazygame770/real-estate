...
interface RegionPricePerMeterRowProps {
  item: RegionPricePerMeterData;
}

export const RegionPricePerMeterRow = ({ item }: RegionPricePerMeterRowProps) => {
  const { t } = useLanguage();
  ...
  return (
    ...
    >
      ...
      <TableCell className="text-right py-2 px-4 text-foreground">{formatPrice(item.minPricePerMeter)}</TableCell>
      <TableCell className="text-right py-2 px-4 font-medium text-foreground">{formatPrice(item.avgPricePerMeter)}</TableCell>
      <TableCell className="text-right py-2 px-4 text-foreground">{formatPrice(item.maxPricePerMeter)}</TableCell>
